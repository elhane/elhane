...
Люблю фронтенд за возможность работать с интерфейсами, которые могут быть полезны лично мне и другим пользователям. Изучаю React и его экосистему, Next.js, так же хочу продолжить изучение Vue.
...
|---------------------------------|:----------------------------------------------------------------------------------------------------------------|------|-------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| Personal-frontend-roadmap </br> | [Repo](https://github.com/elhane/url-shortener) [Demo](https://personal-frontend-roadmap.vercel.app/)           |  2022 | <div align='center' title='Pet project'>🐈</div>      | [Work In Progress] Пет-проект, личный роадмап (в планах: структурирование информации для изучения, статистика по поиску работы, todo list) | Nuxt, React                |
